...
public class amino_acid_drill_EC2
{
...
//			System.out.println(rand);
		...
		//REPORT
		//store keys in array to sort
		Object[] keyArray = answer_Hash.keySet().toArray();
		Arrays.sort(keyArray);
		//iterate through answer_Hash by sorted key array
		for( Object key2 : keyArray )
		{
